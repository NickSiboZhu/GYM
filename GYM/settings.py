...
SECRET_KEY = 'django-insecure-%_t46n(!0b$u0*-7m7d$ok24##f7zzqrmf&iw=du*bo!6uh2fr'
...
STATICFILES_DIRS = (os.path.join(BASE_DIR / 'static'),os.path.join(BASE_DIR / 'gymapp' / 'static'),)
